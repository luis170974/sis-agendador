    ...
    <div class="mb-3 col-6">
        ...
        <div class="input-group">
            ...
            <select class="form-select" name="sexoContato" id="sexoContato">
                <option  <?php echo ($dados['sexoContato'] == '')? 'selected' : '' ?> value="">Selecione o genêro do contato</option>
...
<div class="col-6">
    <?php
        if($dados["nomeFotoContato"] == "" || !file_exists('./pages/contatos/fotos-contatos/'. $dados["nomeFotoContato"])){
