...
<div>
    <form class="needs-validation" action="index.php?menuop=inserir-tarefa" method="post" novalidate>
        <div class="mb-3">
            <label for="tituloTarefa" class="form-label">Titulo</label>
        ...
        <div class="mb-3">
            ...
            <textarea name="descricaoTarefa" id="descricaoTarefa" cols="30" rows="5" class="form-control" style="resize: none" required></textarea>
        </div>
        ...
        <div class="row">
            <div class="mb-3 col-3">
                <label for="recorrenciaTarefa"> Recorrência</label>
